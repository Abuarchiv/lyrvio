...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `${city.apartmentsPerDay} neue Inserate täglich, ${city.avgBewerber} Bewerber pro Wohnung. Ø Wartezeit manuell: ${city.waitTimeManualMonths} Monate. Mit Lyrvio: ${city.waitTimeWithLyrvioWeeks} Wochen. Jetzt Lyrvio aktivieren.`,
          ...
          <div className="mx-auto max-w-[1400px] px-6 lg:px-10 py-20">
            <div className="border-2 border-ink bg-paper-warm p-8 sm:p-12 max-w-[700px]">
              <div className="flex items-center gap-3 mb-6 flex-wrap">
                <span className="stamp-rotated">§ 24/7</span>
                <span className="tag -sage">Lyrvio aktiv in {city.name}</span>
              </div>
              ...
              <p className="font-mono text-[14px] leading-[1.75] text-ink mb-8 max-w-[48ch]">
                Lass Lyrvio für dich suchen. Aktiviere es — Lyrvio scannt {city.mainPlatforms.join(", ")} rund um die Uhr
